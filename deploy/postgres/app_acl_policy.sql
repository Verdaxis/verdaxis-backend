...
INSERT INTO app_column_policy (table_name, column_name, privilege_type) VALUES
    ...
    ('supplier_offers', 'product_id', 'INSERT'),
    ('supplier_offers', 'delivery_point_id', 'INSERT'),
    ('supplier_offers', 'quantity_mt', 'INSERT'),
    ('supplier_offers', 'min_fill_mt', 'INSERT'),
    ('supplier_offers', 'price_per_mt_usd', 'INSERT'),
    ('supplier_offers', 'availability_window', 'INSERT'),
    ('supplier_offers', 'listing_terms', 'INSERT'),
    ('supplier_offers', 'status', 'INSERT'),
    ('supplier_offers', 'revision', 'INSERT'),
    ('supplier_offers', 'expires_at', 'INSERT'),
    ('supplier_offers', 'created_at', 'INSERT'),
    ('supplier_offers', 'updated_at', 'INSERT'),
    ('supplier_offers', 'idempotency_key', 'INSERT'),
    ('supplier_offers', 'idempotency_request_hash', 'INSERT'),
    ('supplier_offers', 'quantity_mt', 'UPDATE'),
    ('supplier_offers', 'min_fill_mt', 'UPDATE'),
    ('supplier_offers', 'price_per_mt_usd', 'UPDATE'),
    ('supplier_offers', 'availability_window', 'UPDATE'),
    ('supplier_offers', 'listing_terms', 'UPDATE'),
    ('supplier_offers', 'status', 'UPDATE'),
    ('supplier_offers', 'revision', 'UPDATE'),
    ('supplier_offers', 'expires_at', 'UPDATE'),
    ('supplier_offers', 'updated_at', 'UPDATE'),
    ('rfqs', 'source_offer_id', 'INSERT'),
    ('rfqs', 'target_supplier_org_id', 'INSERT'),
    ('rfqs', 'source_offer_snapshot', 'INSERT'),
    ('rfqs', 'id', 'INSERT'),
    ('rfqs', 'buyer_org_id', 'INSERT'),
    ('rfqs', 'buyer_user_id', 'INSERT'),
    ('rfqs', 'product_id', 'INSERT'),
    ('rfqs', 'delivery_point_id', 'INSERT'),
    ('rfqs', 'quantity_mt', 'INSERT'),
    ('rfqs', 'target_price_per_mt', 'INSERT'),
    ('rfqs', 'availability_window', 'INSERT'),
    ('rfqs', 'notes', 'INSERT'),
    ('rfqs', 'contract_terms', 'INSERT'),
    ('rfqs', 'is_anonymous', 'INSERT'),
    ('rfqs', 'status', 'INSERT'),
    ('rfqs', 'accepted_quote_id', 'INSERT'),
    ('rfqs', 'trade_id', 'INSERT'),
    ('rfqs', 'expires_at', 'INSERT'),
    ('rfqs', 'created_at', 'INSERT'),
    ('rfqs', 'status', 'UPDATE'),
    ('rfqs', 'accepted_quote_id', 'UPDATE'),
    ('rfqs', 'trade_id', 'UPDATE'),
    ('rfq_quotes', 'id', 'INSERT'),
    ('rfq_quotes', 'rfq_id', 'INSERT'),
    ('rfq_quotes', 'seller_org_id', 'INSERT'),
    ('rfq_quotes', 'seller_user_id', 'INSERT'),
    ('rfq_quotes', 'price_per_mt_usd', 'INSERT'),
    ('rfq_quotes', 'notes', 'INSERT'),
    ('rfq_quotes', 'offer_terms', 'INSERT'),
    ('rfq_quotes', 'expires_at', 'INSERT'),
    ('rfq_quotes', 'revision', 'INSERT'),
    ('rfq_quotes', 'status', 'INSERT'),
    ('rfq_quotes', 'created_at', 'INSERT'),
    ('rfq_quotes', 'price_per_mt_usd', 'UPDATE'),
    ('rfq_quotes', 'notes', 'UPDATE'),
    ('rfq_quotes', 'status', 'UPDATE'),
    ('rfq_quotes', 'offer_terms', 'UPDATE'),
    ('rfq_quotes', 'expires_at', 'UPDATE'),
    ('rfq_quotes', 'revision', 'UPDATE'),
