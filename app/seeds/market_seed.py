...
PRICING: dict[str, dict[str, tuple[float, float, float, float]]] = {
    "Methanol Green": {
        "ARA":       (800, 860, 830, 900),
        "Singapore": (850, 910, 880, 950),
        "Fujairah":  (830, 880, 860, 920),
        "Rotterdam": (805, 865, 835, 905),
    },
    "VLSFO Conventional": {
        "ARA":       (480, 520, 500, 540),
        "Singapore": (500, 540, 520, 560),
        "Fujairah":  (490, 530, 510, 550),
    },
    "Biofuel Bio": {
        "ARA":       (720, 780, 750, 810),
        "Singapore": (760, 820, 790, 850),
        "Fujairah":  (740, 800, 770, 830),
    },
    "Ammonia Green": {
        "ARA":       (580, 640, 610, 670),
        "Singapore": (630, 690, 660, 720),
    },
    "LNG Conventional": {
        "ARA":       (850, 920, 880, 950),
        "Singapore": (880, 950, 910, 980),
    },
    "MGO Conventional": {
        "ARA":       (550, 600, 570, 620),
        "Singapore": (570, 620, 590, 640),
    },
}
