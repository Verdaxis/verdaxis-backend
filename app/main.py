...
from app.routers.market_support import (
    admin_router as market_support_admin_router,
    customer_router as market_support_customer_router,
)
...
app.include_router(market_support_admin_router, prefix=settings.API_V1_STR)
app.include_router(market_support_customer_router, prefix=settings.API_V1_STR)
