...
from app.models.orderbook import OrderBookOrder, OrderSide, AvailabilityWindow
...
def _make_order(
    ...
    price: str,
    quantity: str = "1000",
    window: AvailabilityWindow = AvailabilityWindow.SPOT,
):
...
class TestCrossingDetectionFilters:
    ...
    async def test_bid_crossing_uses_same_product_delivery_point_and_window_filters(self, db):
        ...
        bid = _make_order(
            ...
            singapore.id,
            "550",
            window=AvailabilityWindow.SPOT,
        )
        ...
        wrong_window_ask = _make_order(
            ...
            rotterdam.id,
            "470",
            window=AvailabilityWindow.Q1_2026,
        )
