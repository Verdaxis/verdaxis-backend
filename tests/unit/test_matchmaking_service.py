...
class TestMatchScoring:
    def test_perfect_match(self):
        """Same fuel, same region, overlapping price, overlapping delivery."""
        score, reasons = compute_match_score(
            ...
            bid_delivery_start=date(2026, 3, 1), bid_delivery_end=date(2026, 3, 31),
            ask_delivery_start=date(2026, 3, 1), ask_delivery_end=date(2026, 3, 31),
        )
