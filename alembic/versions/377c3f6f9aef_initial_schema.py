...
def upgrade() -> None:
    ...
    # Use native_enum=False to avoid DuplicateObjectError
    # This will create VARCHAR columns with CHECK constraints instead of native types.
    
    # Organizations
    op.create_table('organizations',
        sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
        sa.Column('name', sa.String(), nullable=False),
        sa.Column('type', sa.Enum('SHIPPING_LINE', 'FUEL_SUPPLIER', 'PORT_AUTHORITY', name='org_type', native_enum=False), nullable=False),
    ...
    op.create_table('users',
        ...
        sa.Column('role', sa.Enum('BUYER', 'SUPPLIER', 'ADMIN', name='user_role', native_enum=False), nullable=False),
    ...
    op.create_table('port_intelligence',
        ...
        sa.Column('congestion_level', sa.Enum('Low', 'Moderate', 'High', name='congestion_level', native_enum=False), nullable=True),
    ...
    op.create_table('inventory_items',
        ...
        sa.Column('fuel_type', sa.Enum('Methanol', 'Biofuel', 'LNG', 'Ammonia', 'LSMGO', name='fuel_type', native_enum=False), nullable=False),
    ...
    op.create_table('quote_requests',
        ...
        sa.Column('status', sa.Enum('Draft', 'Pending', 'Quoted', 'Negotiating', 'Confirmed', 'Rejected', 'Completed', name='quote_status', native_enum=False), nullable=False),
