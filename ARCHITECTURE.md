...
deploy/systemd/                  # Backend units plus exactly one news service/timer pair per deployed environment
...
scripts/verify_systemd_source.py # Exact clean release-ref/unit-byte provenance gate
